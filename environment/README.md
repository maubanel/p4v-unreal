...
It is a good idea to use a config file so that it automatically configs your environment correctly in each project. For PC's only, download the [set_p4_pc.bat](../files/ue5/set_p4_pc.bat) for PCs or or [set_p4_mac.sh](../files/ue5/set_p4_mac.sh) file for macs.
